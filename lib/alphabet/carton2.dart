...
class carton2 extends StatefulWidget {
  const carton2({super.key});

  @override
  State<carton2> createState() => _carton2State();
}

class _carton2State extends State<carton2> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/carton2.mp4')
          ..initialize().then((_) {
