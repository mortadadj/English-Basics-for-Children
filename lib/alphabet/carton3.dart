...
class carton3 extends StatefulWidget {
  const carton3({super.key});

  @override
  State<carton3> createState() => _carton3State();
}

class _carton3State extends State<carton3> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/carton3.mp4')
          ..initialize().then((_) {
