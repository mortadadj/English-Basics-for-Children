...
class color_carton3 extends StatefulWidget {
  const color_carton3({super.key});

  @override
  State<color_carton3> createState() => _color_carton3State();
}

class _color_carton3State extends State<color_carton3> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/color_carton3.mp4')
          ..initialize().then((_) {
