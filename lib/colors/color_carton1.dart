...
class color_carton1 extends StatefulWidget {
  const color_carton1({super.key});

  @override
  State<color_carton1> createState() => _color_carton1State();
}

class _color_carton1State extends State<color_carton1> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/color_carton1.mp4')
          ..initialize().then((_) {
