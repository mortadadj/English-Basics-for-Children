...
class color_carton2 extends StatefulWidget {
  const color_carton2({super.key});

  @override
  State<color_carton2> createState() => _color_carton2State();
}

class _color_carton2State extends State<color_carton2> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/color_carton2.mp4')
          ..initialize().then((_) {
