...
class animls_carton1 extends StatefulWidget {
  const animls_carton1({super.key});

  @override
  State<animls_carton1> createState() => _animls_carton1State();
}

class _animls_carton1State extends State<animls_carton1> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/animals_carton1.mp4')
          ..initialize().then((_) {
