...
class animls_carton3 extends StatefulWidget {
  const animls_carton3({super.key});

  @override
  State<animls_carton3> createState() => _animls_carton3State();
}

class _animls_carton3State extends State<animls_carton3> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/animals_carton4.mp4')
          ..initialize().then((_) {
