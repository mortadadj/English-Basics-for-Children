...
class animls_carton5 extends StatefulWidget {
  const animls_carton5({super.key});

  @override
  State<animls_carton5> createState() => _animls_carton5State();
}

class _animls_carton5State extends State<animls_carton5> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/video/animals_carton5.mp4')
          ..initialize().then((_) {
